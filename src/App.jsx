...
function App() {
  ...
  const handleLogout = async () => {
    try {
      await signOut(auth);
      // onAuthStateChanged will trigger, setting userId to null
                    ...
                    downloadCSV(
                      convertToCSV(
                        sortedInventory.map((c) => [
                          ...
                          (c.tareWeightLbs || 0).toFixed(2),
                          (c.currentFill?.grossWeightLbs || 0).toFixed(2),
                          (c.currentFill?.netWeightLbs || 0).toFixed(2),
                          (c.currentFill?.proof || 0).toFixed(2),
                          (c.currentFill?.wineGallons || 0).toFixed(2),
                          (c.currentFill?.proofGallons || 0).toFixed(2),
